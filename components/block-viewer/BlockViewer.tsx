...
const BlockViewer = (props: BlockViewerProps) => {
    ...
    const actionCopyRef = useRef<HTMLButtonElement | null>(null);
            ...
            <div className="block-section">
                <div className="block-header">
                    ...
                    <div className="block-actions">
                        ...
                        <ToolTip target={actionCopyRef as React.RefObject<HTMLElement>} position="bottom" content="Copied to clipboard" event="focus" />
                    </div>
                </div>
